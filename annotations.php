...
class Annotation
{
    ...
    /**
     * @var array contains a string array that store any log message like warnings or errors.
     * @author Erik Amaru ortiz <aortiz.erik@gmail.com>
     */
...
class AnnotationsBuilder
{
    ...
    {
        //erik 7/8/2011: first at all verify if the class exists
        if (class_exists($class)) {
            ...
            Annotation::log("Skipped - Annotated class defined $class but doesn't exist");
        }
        return false;
    }
